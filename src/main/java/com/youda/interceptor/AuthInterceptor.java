...
public class AuthInterceptor implements HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		/*验证请求权限*/
		System.err.println("请求方法:"+method+"\t请求URL:"+url);
		HandlerMethod handlerMethod = (HandlerMethod) handler;
		Method methodHan = handlerMethod.getMethod();
		
		if(methodHan.getAnnotation(Authorization.class) == null)
		{
			return true;
		}
		...
		System.err.println("请求的token值:"+accessToken);
		String userId = request.getHeader("userId");
		System.err.println("请求的用户Id:"+userId);

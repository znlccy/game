...
public interface PayMapper {
    ...
    /*实现自定义日期付费率统计*/
    @Select("SELECT IFNULL(FORMAT((payPlayerCount.payCount/(userActiveCount.userActiveCount)*100),2),0.00) AS StatisticsRate,payPlayerCount.StatisticsDate AS StatisticsDate    \n" +
            " FROM    \n" +
            " (    \n" +
